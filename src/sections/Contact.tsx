                        ...
                        <form className="flex flex-col p-8 lg:pt-40 pt-20 ml-10 sm:m-0 sm:p-2 sm:items-center md:items-center lg:w-full gap-4" onSubmit={handleSubmit}>
                            <div className="flex flex-row lg:w-[450px] md:w-[450px] sm:w-full sm:flex-col gap-8">
                                <div>
                                    ...
                                    <input className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 dark:text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" placeholder="Amine"
                                        type="text"
                                        name="fName"
                                ...
                                <div>
                                    ...
                                    <input className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" placeholder="Bajji"
                                        type="text"
                                        name="lName"
                            ...
                            <div className="flex flex-col flex flex-row lg:w-[450px] md:w-[450px] sm:w-full sm:flex-col gap-8">
                                <div>
                                    ...
                                    <input className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block lg:w-[450px] md:w-[450px] sm:w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" placeholder="+212-751-781-644"
                                        type="tel"
                                        name="phoneNumber"
                                ...
                                <div>
                                    ...
                                    <input className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block lg:w-[450px] md:w-[450px] sm:w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500 shadow-sm-light" placeholder="amine.bajji.dev@gmail.com"
                                        type="email"
                                        name="mail"
                                ...
                                <div className="mt-4">
                                    ...
                                    <textarea className="block p-2.5 lg:w-[450px] md:w-[450px] h-[100px] sm:w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="Leave me a message here..."
                                        name="message"
